...
| ---------- |------------------------|------------------------|
| `CarPark`    | Location, Capacity     |   |
| `Sensor`     | Name or In/Out, on/off | Count cars,            |
| `Display`    | Available bays, on/off |                        |
...
![Show git tags](images/git-tags.png)
...
1. Add a screenshot of the output of the unit tests. If any failed, add a screenshot of the error message and a screenshot after you have fixed the errors:
   ...
   ![Unit tests](images/unit-tests-display-fail.png)
   
   ![Unit tests](images/unit-tests-display-pass.png)
...
> Given the method is defined in the CarPark class, and given the relationship between these classes (a Car park HAS sensors and HAS displays), it would make sense to run this unit test as part of the CarPark unit tests.
